...
class Export
{
    ...
    public function get ()
    {
        ...
        if (isset($points)) {
            ...
            $pointsOfInterest = PointOfInterest::where('hike_id', $this->userHikeId)->get ();
        ...
        if ($point->dist - $this->startDistance >= $this->maximumDistanceBetweenPoints) {
            if ($this->numberOfPoints >= $this->maxNumberOfPointsPerSegment) {
                ...
                if (isset($this->prevPoint)) {
                    ...
                    $xw->writeAttribute("lat", $this->prevPoint->point->lat);
                    $xw->writeAttribute("lon", $this->prevPoint->point->lng);
            ...
            $xw->writeAttribute("lat", $point->point->lat);
            $xw->writeAttribute("lon", $point->point->lng);
